...
<ul class="tribe-events-sub-nav">
	...
	<?php if ( tribe_has_previous_event() ) : ?>
		<li class="<?php echo tribe_left_navigation_classes(); ?>">
			<a href="<?php echo tribe_get_listview_link() ?>" rel="prev"><?php _e( '<span>&lt;</span> Prev', 'tribe-events-calendar' ) ?></a>
	...
	<?php if ( tribe_has_next_event() ) : ?>
		<li class="<?php echo tribe_right_navigation_classes(); ?>">
			<a href="<?php echo tribe_get_listview_link() ?>" rel="next"><?php _e( 'Next <span>&gt;</span>', 'tribe-events-calendar' ) ?></a>
